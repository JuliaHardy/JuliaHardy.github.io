...
export const getEventData = createAction(GET_EVENT)

export const getEventDataSuccess = createAction(GET_EVENT_SUCCESS, props<any>())

export const getEventDataFailure = createAction(GET_EVENT_FAILURE, props<any>())

export const createEvent = createAction(CREATE_EVENT, props<Event>())
